export const opening = {
  ...
  spanish: `Estimado participante, `,
};

export const explanation = {
  english: `
This two-part study investigates investment decisions. In the first part, you will make portfolio allocation decisions. In the second part, you will be asked some related questions. 
